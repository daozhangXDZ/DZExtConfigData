...
enum class ESIONFolderType : uint8
{
	Content,
	Project,
	Absolute,
...
public:
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "SocketIOFunctions")
	static void ConverFilePath(const FString& FilePath, ESIONFolderType foldType, FString& outPath);
